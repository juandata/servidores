...
bitnami-wampstack-7.0.20-0-windows-installer.exe
...
path will be a folder at C:\Bitnami\wampstack-7.0.20-0. If the destination 
...
C:\Bitnami\wampstack-7.0.20-0 and that you use port 80 for Apache and 3306 for MySQL.
